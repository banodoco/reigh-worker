...
def test_clone_and_install_vibecomfy_emits_byte_identical_shell_portable():
    ...
    expected_lines = [
        ...
        "uv venv --seed --python python3.11 /opt/reigh-vibecomfy-live-test-venv",
        "uv pip install --python /opt/reigh-vibecomfy-live-test-venv/bin/python -e /workspace/vibecomfy",
        # uv pip install of comfyui + comfy-script
        "cd /workspace/vibecomfy",
        "test -f custom_nodes.lock",
        "/opt/reigh-vibecomfy-live-test-venv/bin/python -m vibecomfy.cli nodes restore --lockfile custom_nodes.lock",
